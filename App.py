...
st.set_page_config(
    page_title="Intelligent Resume Scanner",
...
def run():
    ...
    # Create the DB
    connection = sqlite3.connect('SRA.db')  # SQLite DB file
    cursor = connection.cursor()
...
"""
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'administrator' and ad_password == 'administrator':
